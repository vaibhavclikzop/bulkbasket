...
@section('main-section')
    @push('title')
        <title> Orders Challan Draft</title>
    @endpush
                ...
                <tbody>
                    ...
                    @foreach ($data as $item)
                        <tr>
                            ...
                            <td>
                                <button class="btn btn-primary btn-sm estimate-edit" data-data='@json(['id' => $item->id, 'order_status' => $item->order_status])'>
                                    Status
                                </button>
                                <a href="{{ url('/supplier/edit-challan/' . $item->id) }}" class="btn btn-info btn-sm">
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="modalTitleId">Edit Draft Challan Status</h5>
