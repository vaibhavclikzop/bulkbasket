...
@section('main-section')
    ...
    <div class="modal fade" id="exampleModal">
        <div class="modal-dialog">
            <form class="row g-3 needs-validation" novalidate method="POST" action="{{ route('customer/saveDepartment') }}">
                @csrf
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabel"><span id="modal_name"> Add Department</span></h5>
                    ...
                    <div class="modal-body row">
                        ...
                        <div class="col-md-12">
                            ...
                            <input type=""   name="name" id="name" class="form-control" required>
