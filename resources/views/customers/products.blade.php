...
@section('main-section')
    ...
    <div class="card">
        ...
        <div class="px-4 pt-1">
            ...
            <form action="{{ url('customer/products') }}" method="GET" class="mb-3">
                ...
                <tbody>
                    ...
                    @foreach ($products as $item)
                        ...
                        <tr>
                            ...
                            <td> <a href="/product images/{{$item->image}}" target="_blank"> <img src="/product images/{{$item->image}}" width="45px" alt="no image upload"> </a></td>
                            ...
                            <td><button class="btn btn-primary btn-sm edit" type="button" data-id="{{ $item->id }}"
                                    ...
                                    data-raw_material="{{ $item->raw_material }}"
                                    data-gst="{{ $item->gst }}"
                                    data-manual_barcode="{{ $item->manual_barcode }}"
                                    data-cess_tax="{{ $item->cess_tax }}"
    ...
    <div class="modal fade" id="exampleModal">
        <div class="modal-dialog modal-lg">
            <form class="row g-3 needs-validation" novalidate method="POST" action="{{ route('customer/SaveProduct') }}" enctype="multipart/form-data">
                @csrf
                <div class="modal-content">
                    ...
                    <div class="modal-body row">
                        ...
                        <div class="col-md-4 mt-4 ">
                            ...
                            <input id="article_no" name="article_no" class="form-control" placeholder="Enter Article No"
                                required>
    ...
    <form action="{{ route('customer/ImportProducts') }}" method="POST" class="needs-validation" novalidate
