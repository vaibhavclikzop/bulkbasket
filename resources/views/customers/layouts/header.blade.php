 ...
 <body class="">
     ...
     <aside class="sidebar sidebar-base sidebar-white sidebar-default navs-rounded-all " id="first-tour"
         ...
         <div class="sidebar-header d-flex align-items-center justify-content-start">
             <a href="/customer/dashboard" class="navbar-brand">

                 <!--Logo start-->
                 <div class="logo-main">
                     <div class="logo-normal">
                         <img src="/logo/{{ $setting->img }}" width="180">
                     </div>
                     <div class="logo-mini">
         ...
         <div class="sidebar-body pt-0 data-scrollbar">
             <div class="sidebar-list">
                 ...
                 <ul class="navbar-nav iq-main-menu" id="sidebar-menu">
                     ...
                     <li class="nav-item">
                         <a class="nav-link" aria-current="page" href="/customer/dashboard">
                     ...
                     <li class="nav-item">
                         <a class="nav-link" data-bs-toggle="collapse" href="#masters" role="button"
                         ...
                         <ul class="sub-nav collapse" id="masters" data-bs-parent="#sidebar-menu">

                             <li class="nav-item">
                                 <a class="nav-link " href="/customer/vendor">
                                     <i class="icon">
                                     ...
                                     <i class="sidenav-mini-icon" data-bs-toggle="tooltip" title="Vendors"
                                         data-bs-placement="right"> Vendor </i>
                                     <span class="item-name"> Vendors </span>
                                 </a>
                             </li>
                             <li class="nav-item">
                                 <a class="nav-link " href="/customer/department">
                                     <i class="icon">
                                         <svg class="icon-10" width="10" viewBox="0 0 24 24" fill="currentColor"
                                             xmlns="http://www.w3.org/2000/svg">
                                             <g>
                                     ...
                                     <i class="sidenav-mini-icon" data-bs-toggle="tooltip" title="Department"
                                         data-bs-placement="right"> Department </i>
                     ...
                     <li class="nav-item">
                         <a class="nav-link" data-bs-toggle="collapse" href="#horizontal-menu" role="button"
                             ...
                             <span class="item-name">Raw Material </span>
                             <i class="right-icon">
                                 <svg xmlns="http://www.w3.org/2000/svg" width="18" class="icon-18"
                                     fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                     <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                         ...
                         <ul class="sub-nav collapse" id="horizontal-menu" data-bs-parent="#sidebar-menu">
                             <li class="nav-item">
                                 <a class="nav-link " href="/customer/gst">
                                     <i class="icon">
                                         <svg class="icon-10" width="10" viewBox="0 0 24 24" fill="currentColor"
                                             xmlns="http://www.w3.org/2000/svg">
                                             <g>
                                     ...
                                     <i class="sidenav-mini-icon" data-bs-toggle="tooltip" title="GST"
                                         data-bs-placement="right"> GST </i>
                                     <span class="item-name"> GST </span>
                                 </a>
                             </li>
                             <li class="nav-item">
                                 <a class="nav-link " href="/customer/unit-type">
                                     <i class="icon">
                                         <svg class="icon-10" width="10" viewBox="0 0 24 24" fill="currentColor"
                                             xmlns="http://www.w3.org/2000/svg">
                                             <g>
                                     ...
                                     <i class="sidenav-mini-icon" data-bs-toggle="tooltip" title="Unit Type"
                                         data-bs-placement="right"> Unit Type </i>
                                     <span class="item-name"> Unit Type </span>
                                 </a>
                             </li>
                             <li class="nav-item">
                                 <a class="nav-link " href="/customer/brand">
                                     <i class="icon">
                                         <svg class="icon-10" width="10" viewBox="0 0 24 24" fill="currentColor"
                                             xmlns="http://www.w3.org/2000/svg">
                                             <g>
                                     ...
                                     <i class="sidenav-mini-icon" data-bs-toggle="tooltip" title="Brand"
                                         data-bs-placement="right"> B </i>
                                     <span class="item-name"> Brand </span>
                                 </a>
                             </li>
                             <li class="nav-item">
                                 <a class="nav-link " href="/customer/category">
                                     <i class="icon">
                                         <svg class="icon-10" width="10" viewBox="0 0 24 24" fill="currentColor"
                                             xmlns="http://www.w3.org/2000/svg">
                                             <g>
                                     ...
                                     <i class="sidenav-mini-icon" data-bs-toggle="tooltip" title="Category"
                                         data-bs-placement="right"> C </i>
                                     <span class="item-name"> Category </span>
                                 </a>
                             </li>
                             <li class="nav-item">
                                 <a class="nav-link " href="/customer/sub-category">
                                     <i class="icon">
                                         <svg class="icon-10" width="10" viewBox="0 0 24 24" fill="currentColor"
                                             xmlns="http://www.w3.org/2000/svg">
                                             <g>
                                     ...
                                     <i class="sidenav-mini-icon" data-bs-toggle="tooltip" title="Sub Category"
                                         data-bs-placement="right"> SC </i>
                             ...
                             <li class="nav-item">
                                 <a class="nav-link " href="/customer/products">
                                     ...
                                     <i class="sidenav-mini-icon" data-bs-toggle="tooltip" title="Products"
                     ...
                     @if (session('customer')->customer_type == 'caterers')
                         <li class="nav-item">
                             <a class="nav-link" data-bs-toggle="collapse" href="#finish-goods" role="button"
                                 aria-expanded="false" aria-controls="horizontal-menu">
                                 <i class="icon" data-bs-toggle="tooltip" title="Menu Style"
                                     data-bs-placement="right">
                                     <svg width="20" class="icon-20" viewBox="0 0 14 14" fill="none"
                                 ...
                                 <span class="item-name">Finish Goods </span>
                                 <i class="right-icon">
                                     <svg xmlns="http://www.w3.org/2000/svg" width="18" class="icon-18"
                                         fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                         <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                             ...
                             <ul class="sub-nav collapse" id="finish-goods" data-bs-parent="#sidebar-menu">

                                 <li class="nav-item">
                                     <a class="nav-link " href="/customer/finish-product-category">
                                         <i class="icon">
                                 ...
                                 <li class="nav-item">
                                     <a class="nav-link " href="/customer/finish-product">
                                         <i class="icon">
                                             <svg class="icon-10" width="10" viewBox="0 0 24 24"
                                                 fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                                                 <g>
                         ...
                         <li class="nav-item">
                             <a class="nav-link " aria-current="page" href="/customer/gathering-list">
                                 <i class="fa-solid fa-utensils"></i>
                                 <span class="item-name">Gathering Master</span>
                             </a>
                         </li>

                         <li class="nav-item">
                             <a class="nav-link " aria-current="page" href="/customer/customer">
                         ...
                         <li class="nav-item">
                             <a class="nav-link " aria-current="page" href="/customer/customer-gathering">
                                 <i class="fa-solid fa-bowl-food"></i>
                                 <span class="item-name">Customer Gathering</span>
                             </a>
                         </li>
                     @endif

                     <li class="nav-item">
                         <a class="nav-link" data-bs-toggle="collapse" href="#purchase-management" role="button"
                             aria-expanded="false" aria-controls="horizontal-menu">
                         ...
                         <ul class="sub-nav collapse" id="purchase-management" data-bs-parent="#sidebar-menu">
                             ...
                             <li class="nav-item">
                                 <a class="nav-link " href="/customer/generate-po">
                                     <i class="icon">
                                         <svg class="icon-10" width="10" viewBox="0 0 24 24" fill="currentColor"
                                             xmlns="http://www.w3.org/2000/svg">
                                             <g>
                                     ...
                                     <i class="sidenav-mini-icon" data-bs-toggle="tooltip" title="Generate PO"
                                         data-bs-placement="right"> GP </i>
                                     <span class="item-name"> Generate PO </span>
                                 </a>
                             </li>
                             <li class="nav-item">
                                 <a class="nav-link " href="/customer/po/generated">
                                     <i class="icon">
                                         <svg class="icon-10" width="10" viewBox="0 0 24 24" fill="currentColor"
                                             xmlns="http://www.w3.org/2000/svg">
                                             <g>
                                     ...
                                     <i class="sidenav-mini-icon" data-bs-toggle="tooltip" title="Generated PO"
                                         data-bs-placement="right"> GP </i>
                             ...
                             <li class="nav-item">
                                 <a class="nav-link " href="/customer/po/partial">
                                     <i class="icon">
                                         <svg class="icon-10" width="10" viewBox="0 0 24 24" fill="currentColor"
                                             xmlns="http://www.w3.org/2000/svg">
                                             <g>
                                     ...
                                     <i class="sidenav-mini-icon" data-bs-toggle="tooltip" title="Partial Approved"
                                         data-bs-placement="right"> PA </i>
                                     <span class="item-name"> Partial Approved </span>
                                 </a>
                             </li>

                             <li class="nav-item">
                                 <a class="nav-link " href="/customer/po/complete">
                                     <i class="icon">
                                         <svg class="icon-10" width="10" viewBox="0 0 24 24" fill="currentColor"
                                             xmlns="http://www.w3.org/2000/svg">
                                             <g>
                                     ...
                                     <i class="sidenav-mini-icon" data-bs-toggle="tooltip" title="Full Approved"
                     ...
                     <li class="nav-item">
                         <a class="nav-link" aria-current="page" href="/customer/inward-stock">
                             <i class="fa fa-download" aria-hidden="true"></i>
                             <span class="item-name">Inward Stock</span>
                         </a>
                     </li>
                     <li class="nav-item">
                         <a class="nav-link" aria-current="page" href="/customer/inward-report">
                             <i class="fa fa-pie-chart" aria-hidden="true"></i>
                             <span class="item-name">Inward Report</span>
                         </a>
                     </li>
                     <li class="nav-item">
                         <a class="nav-link" aria-current="page" href="/customer/outward-stock">
                             <i class="fa fa-upload" aria-hidden="true"></i>
                             <span class="item-name">Outward Stock</span>
                         </a>
                     </li>
                     <li class="nav-item">
                         <a class="nav-link" aria-current="page" href="/customer/outward-report">
                             <i class="fa fa-bar-chart" aria-hidden="true"></i>
                             <span class="item-name">Outward Report</span>
                         </a>
                     </li>
                     ...
                     <li class="nav-item">
                         <a class="nav-link" data-bs-toggle="collapse" href="#expense" role="button"
                             aria-expanded="false" aria-controls="horizontal-menu">
                             <i class="fa fa-bar-chart" aria-hidden="true"></i>
                             <span class="item-name">Customer Expense</span>
                             <i class="right-icon">
                                 <svg xmlns="http://www.w3.org/2000/svg" width="18" class="icon-18"
                                     fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                     <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                         ...
                         <ul class="sub-nav collapse" id="expense" data-bs-parent="#sidebar-menu">
                             ...
                             <li class="nav-item">
                                 <a class="nav-link " href="/customer/expense-subcategory">
                                     <i class="icon">
                                         <svg class="icon-10" width="10" viewBox="0 0 24 24" fill="currentColor"
                                             xmlns="http://www.w3.org/2000/svg">
                                             <g>
                             ...
                             <li class="nav-item">
                                 <a class="nav-link " href="/customer/expense-list">
                                     <i class="icon">
                                         <svg class="icon-10" width="10" viewBox="0 0 24 24" fill="currentColor"
                                             xmlns="http://www.w3.org/2000/svg">
                                             <g>
                                         ...
                                         <div class="p-0 card-body all-notification">
                                             <a href="#" class="iq-sub-card">
                                                 <div class="d-flex align-items-center">
                                                     <img class="p-1 avatar-40 rounded-pill bg-soft-primary"
                                                         src="/backend/images/01_1.png" alt=""
                                                         loading="lazy">
                                             ...
                                             <a href="#" class="iq-sub-card">
                                                 <div class="d-flex align-items-center">
                                                     <div>
                                                         <img class="p-1 avatar-40 rounded-pill bg-soft-primary"
                                                             src="/backend/images/02_1.png" alt=""
                                                             loading="lazy">
                                                     </div>
                                                     <div class="ms-3 w-100">
                                             ...
                                             <a href="#" class="iq-sub-card">
                                                 <div class="d-flex align-items-center">
                                                     <img class="p-1 avatar-40 rounded-pill bg-soft-primary"
                                                         src="/backend/images/03_1.png" alt=""
                                                         loading="lazy">
                                                     <div class="ms-3 w-100">
                                             ...
                                             <a href="#" class="iq-sub-card">
                                                 <div class="d-flex align-items-center">
                                                     <img class="p-1 avatar-40 rounded-pill bg-soft-primary"
                                                         src="/backend/images/04_1.png" alt=""
                                                         loading="lazy">
                             ...
                             <li class="nav-item dropdown">
                                 <a class="py-0 nav-link d-flex align-items-center ps-3" href="#"
                                     ...
                                     <div class="caption ms-3 d-none d-md-block ">
                                         <h6 class="mb-0 caption-title">{{ session('customer')->name }}</h6>
                                         <p class="mb-0 caption-sub-title"{{ session('customer')->number }}></p>
                                     </div>
                                 </a>
