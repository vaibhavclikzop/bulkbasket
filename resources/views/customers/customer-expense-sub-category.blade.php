...
@section('main-section')
    @push('title')
        <title> Customer Expense Sub Category</title>
    @endpush
    ...
    <form action="{{ route('customer/expenseSaveSubCategory') }}" method="POST" class="needs-validation" novalidate
