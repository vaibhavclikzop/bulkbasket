...
@section('main-section')
    ...
    <div class="content-inner container-fluid pb-0" id="page_layout">
        <div class="card">
            <div class="card-header">
                ...
                <form action="{{ route('s1/SaveSlider3') }}" method="POST" class="needs-validation" novalidate
                    enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                        <div class="col-md-3" <span style="color: red">Img Size (395*250)px</span>
    ...
    <form action="{{ route('s1/SaveSlider3') }}" method="POST">
        @csrf
