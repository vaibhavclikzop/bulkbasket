...
@section('main-section')
                    ...
                    <tbody>
                        ...
                        @foreach ($data as $item)
                            <tr>
                                ...
                                <td>{{ $item->name }}</td>
                                <td>
                                    <img src="/faq-images/{{ $item->image }}" width="80px">
                                </td>
                                <td>{{ $item->seq }}</td>
                                <td>
    ...
    <form action="{{ route('s1/faqSaveCategory') }}" method="POST" class="needs-validation" novalidate
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <label for="" class="mt-3">Seq</label>
