...
@section('main-section')
    ...
    <div class="content-inner container-fluid pb-0" id="page_layout">
        <div class="card">
            ...
            <div class="card-body">
                <form action="{{ route('s1/refundSaveMain', $privacy->id) }}" method="POST" class="needs-validation" novalidate
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            ...
                            <input type="text" name="title" class="form-control" value="{{ $privacy->title }}"
                                placeholder="Enter Title" required>
                        </div>

                        <div class="col-md-12 mt-3">
                            <label for="form-control">Content</label>
                            <textarea type="text" name="content" id="div_editor1" placeholder="Enter Description" required>{{ $privacy->content }}</textarea>
                        </div>
