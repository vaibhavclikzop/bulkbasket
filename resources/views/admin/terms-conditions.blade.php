...
@section('main-section')
    ...
    <div class="content-inner container-fluid pb-0" id="page_layout">
        <div class="card">
            ...
            <div class="card-body">
                <form action="{{ route('s1/refundSaveMain', $term->id) }}" method="POST" class="needs-validation" novalidate
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12 mt-3">
                            ...
                            <textarea type="text" name="content" id="div_editor1" placeholder="Enter Description" required>{{ $term->content }}</textarea>
                        </div>
